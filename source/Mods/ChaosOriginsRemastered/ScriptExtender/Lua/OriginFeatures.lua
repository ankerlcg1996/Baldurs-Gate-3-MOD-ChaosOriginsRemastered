...
M.Definitions = {
    { Name = "Astarion", Passive = "COR_Origin_Astarion", Status = "COR_ORIGIN_ASTARION",
    ...
    { Name = "Gale", Passive = "COR_Origin_Gale", Status = "COR_ORIGIN_GALE",
        Tag = "9b0354c0-56d9-4723-8034-918ac9abab19",
        Passives = { { "ORI_Gale_ShadowSpellSlots", 5 } },
        Spells = { { "Target_ORI_Gale_ShadowSummon", 5 } } },
    { Name = "Laezel", Passive = "COR_Origin_Laezel", Status = "COR_ORIGIN_LAEZEL",
        Tag = "b5682d1d-c395-489c-9675-1f9b0c328ea5", Passives = {}, Spells = {} },
    { Name = "Shadowheart", Passive = "COR_Origin_Shadowheart", Status = "COR_ORIGIN_SHADOWHEART",
        Tag = "642d2aee-e3df-47e3-9f47-bbcd441bb9e0", Passives = {}, Spells = {} },
    { Name = "Wyll", Passive = "COR_Origin_Wyll", Status = "COR_ORIGIN_WYLL",
    ...
    { Name = "Karlach", Passive = "COR_Origin_Karlach", Status = "COR_ORIGIN_KARLACH",
    ...
    { Name = "DarkUrge", Passive = "COR_Origin_DarkUrge", Status = "COR_ORIGIN_DARKURGE",
